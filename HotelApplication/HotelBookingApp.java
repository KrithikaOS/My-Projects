...
public class HotelBookingApp {
    ...
    public static void bookHotel(int money, int days, int rating) throws Exception {
       ...
       if(answer == null) {System.out.println("Sorry! you dont have sufficient amount to book any hotel");}
       else {
           Double cost= app.applyDiscount(answer, preference) * preference.getDays();
       System.out.println(" 'Hotel Booked for " + preference.getDays() + " days in " + preference.getRatingPreference() + " star Hotel " + answer.getName() + " for the cost of " + cost + " for hotel");
       }
